...
from .views import QuestCounterViewSet, QuestCounterByIdViewSet, VoteStatusViewSet, QuestViewSet, QuestByStreamerViewSet
...
router.register(r'get-quest-by-streamer', QuestByStreamerViewSet)
